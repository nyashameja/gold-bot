...
use Dotenv\Dotenv;
use GoldBot\Core\ErrorHandler as AppErrorHandler;
 ...
 * app/Support/helpers.php and for the two entry points. Application code
...
final class Application
{
    ...
    private function registerErrorHandling(Config $config): void
    {
        ...
        $handler = new AppErrorHandler($logger, $debug, PHP_SAPI === 'cli');
        $handler->register();

        $this->container->instance(AppErrorHandler::class, $handler);

 ...
 *
 * Deliberately minimal — GET with query parameters is all any Gold Bot
 * provider needs. TLS verification is on and there is no option to disable it:
 * an unverified connection to a market data feed is an invitation to be fed
 * fabricated prices.
 */
final class HttpClient
{
    public function __construct(
        ...
        private readonly string $userAgent = 'GoldBot/1.0'
    ) {
    }
